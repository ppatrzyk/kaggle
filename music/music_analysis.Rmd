...
## Where USA and UK does not dominate
...
For which genres the top producer (aggregated  scrobbles) is not USA or UK or the top artist is not from there? 
...
# workaround to make genres appear in correct order
# numeric factor plotted, thne replaced by correct label in scale
