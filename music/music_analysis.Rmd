...
- Last.fm users do not constitute representative sample of world's music listeners. Hence, the number of scrobbles is an imperfect proxy to the number of times given artist has been listened to. Dominance of western music is determined in part by the fact that the majority of Last.fm users come from these countries. It is very likely that especially African artists have quite bad statistics due to the lack of domestic fans being present on Last.fm.
