...
Countries on map are colored by the total number of scrobbles produced (empirical quantile) labeled by the top artists coming from there. Click onn a country to get its name and actual scrobble count.
...
List of genres where the top producer (aggregated scrobbles) is not USA or UK or the top artist is not from there: 
