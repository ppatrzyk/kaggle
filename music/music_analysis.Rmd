...
lfm[
  artist_lastfm %in% c('Rihanna', 'System of a Down', 'Shakira', 'Gotan Project'),
...
```{r, relativeproduction, echo=TRUE}
# todo genre favtor order different for each facet
...
genres_within_bar <- ggplot(
  genres_within_data,
  aes(factor(genre, levels = unique(genre)), country_perc)
) +
  geom_col(
    fill = '#ED7953FF'
  ) +
